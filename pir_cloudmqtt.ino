...
const int port = 13618;
const char* username = "fapklclj";
const char* server_password = "vX3wzZVMZRRi";
...
void reconnect() {
  ...
  while (!client.connected()) {
    ...
    // Attempt to connect
    if (client.connect(clientId.c_str(),username, server_password)) {
...
void setup() {
  ...
  client.connect("ESP8266Client", username,server_password );
  client.setServer(mqtt_server, 13618);
